...
const setMenuData = async () => {
      ...
      const { categories, variations, restaurant, addongroups, items, addongroup_item_variations, taxes, dine_in_tables, groups } = menu.data;
      ...
      try {
            ...
            const itemVariationstmt = db3.prepare("INSERT INTO item_variation (id,item_id,variation_id,price) VALUES (?,?,?,?)");
                        ...
                        if (item.variations.length) {
                              db3.transaction(() => {
                                    for (const itemVariation of item.variations) {
                                          itemVariationstmt.run(itemVariation.pivot.id, itemVariation.pivot.item_id, itemVariation.pivot.variation_id, itemVariation.pivot.price);
                                    }
                              })();
                        }
                  }
